...
#
#
# class DefineErrorException(Exception):
...
#
# try:
#     raise DefineErrorException(1000 + 222 * 56789567)
# except DefineErrorException as e:
...
#
# except 把它截住，那么这个异常会在 finally 子句执行后再次被抛出。
#
