...
# TODO;可更改(mutable)与不可更改(immutable)对象
# """
...
#
# printinfo('a',11)
# printinfo(name='a',age=11)
# printinfo(age='a',name=11)
#
...
# pintiinfo()
# pintiinfo("aaa", 1231)
# pintiinfo(name="aaa", age=1231)
# pintiinfo(age="aaa", name=1231)
#
#
...
#
# sub = lambda agr1, arg2: agr1 - arg2
#
# # 调用sub函数
# print("相减后的值为 : ", sub(10, 20))
# print("相减后的值为 : ", sub(20, 20))
#
...
#     return result
#
# print(summ(11,1,1,1,1,1,2,1,1,1,1,12,2,3,1,23,13))
#
